...
BEGIN_MESSAGE_MAP(CPoissonApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CPoissonApp::OnAppAbout)
...
CPoissonApp::CPoissonApp()
{
	...
	SetAppID(_T("Poisson.AppID.NoVersion"));
...
// CPoissonApp customization load/save methods

void CPoissonApp::PreLoadState()
{
}

void CPoissonApp::LoadCustomState()
{
}

void CPoissonApp::SaveCustomState()
{
}
